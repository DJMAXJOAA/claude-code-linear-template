...
| Skills | 12 | dev-pipeline, gen-hub, gen-plan, implement, bug-fix, feature-close, triage, feedback, investigation, verify, test, spec |
...
| `/점검` | 수동 테스트 결과 분류 (7유형 triage) | triage |
