...
verify {PASS/FAIL/SKIP} — SC {통과}/{전체}, Verification {통과}/{전체}.
수동 테스트 {M}개 항목 확인 필요.
```

> **SKIP 표현**: verify_result가 SKIP인 경우: `verify SKIP — 사용자 요청으로 검증 생략. 수동 확인 필요.` SC/Verification 통과 현황은 생략.
