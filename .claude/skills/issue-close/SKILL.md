...
| **improvement-deep** | 1→2→3→4→5→5a→6→7→8 | ✅ 기록 | ✅ | ✅ | ✅ (Spec 참조 존재 시) |
| **improvement-light** | 1→2→4→5→**6(조건부)**→8 | ❌ 없음 | ❌ | ✅ (blocked-by 역참조 존재 시) | ❌ |
| **bug** | 1→2→4→5→**6(조건부)**→8 | ❌ (plan.md 없음) | ❌ | ✅ (blocked-by 역참조 존재 시) | ❌ |
