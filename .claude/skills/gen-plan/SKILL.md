...
| technical.md | `docs/issue/{LINEAR-ID}/technical.md` |
...
> gen-plan은 `oh-my-claudecode:ralplan`을 호출하여 plan.md + technical.md를 생성한다. Plan 리뷰는 dev-pipeline의 Post-Plan Q/A에서 `oh-my-claudecode:architect` ∥ `oh-my-claudecode:critic` 병렬 합의 리뷰 사용.
