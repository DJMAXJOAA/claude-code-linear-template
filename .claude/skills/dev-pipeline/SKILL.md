...
> **적용 대상**: Feature Standard, Feature Deep. Feature Light는 Pre-Plan Q/A를 스킵하고 plan(omc) → executor로 직행한다.
...
|------|-----------|------|---------|
| feature | Light | plan(omc) → executor 직행 | sonnet (executor). Pre-Plan Q/A 스킵 |
