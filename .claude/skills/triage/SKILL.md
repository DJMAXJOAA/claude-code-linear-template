...
| 행동 | 상세 |
|------|------|
| 분류 결과 요약 comment | G4 완료 후 1회 |
| L3 bug Issue 생성 | gen-hub 경유 |
| P1 판정 근거 + plan 수정 사유 기록 | P1 처리 시 comment |
| plan-L3 sub-issue 생성 | parentId 지정, 블로킹 사유 comment 포함 |
| plan-backlog improvement 이슈 생성 | 참조 링크 comment 포함 |
