---
name: bug-fix
description: "bug type Issue의 수정 프로세스 오케스트레이터. Git 폴더 + note.md 생성. plan.md는 인터뷰 분기(선택)."
---

# bug-fix — 버그 수정 오케스트레이터

bug type Issue의 수정 프로세스를 오케스트레이션한다. Git 폴더 + note.md를 생성하며, plan.md는 인터뷰 분기(선택)로 제공한다.
...
|------|------|
| 코드 변경 | 버그 수정 + 테스트 |
| Git 문서 | `docs/issue/{LINEAR-ID}/` — note.md, plan.md(선택) |
